...
export default function Button({
  ...
  const baseStyles =
    "group inline-flex items-center justify-between font-tech text-xs sm:text-sm tracking-wider sm:tracking-widest uppercase transition-all duration-200 focus:outline-none select-none disabled:opacity-40 disabled:cursor-not-allowed max-w-full min-w-0 flex-wrap sm:flex-nowrap gap-2";

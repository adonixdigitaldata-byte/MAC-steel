    ...
    <div ref={wrapRef} className="relative bg-carbon" style={{ height: "200vh" }}>
      <section className="sticky top-0 h-[100svh] bg-carbon text-bone overflow-hidden border-b border-carbon-border">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, rgba(14,15,17,0.72) 0%, rgba(14,15,17,0.42) 36%, rgba(14,15,17,0.08) 64%, rgba(14,15,17,0.0) 100%)",
          }}
        />
        {/* Bottom subtle bleed */}
        <div
        ...
        <div className="relative z-10 h-full flex flex-col justify-between max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-6 sm:pt-20 pb-6 pointer-events-none">
          ...
          <div
            ref={textRef}
            className="pointer-events-auto mt-auto mb-auto md:max-w-[44%]"
            style={{ opacity: 1 }}
          >
            <h1
          ...
          {/* Bottom bar */}
          <div className="flex items-center justify-between border-t border-carbon-border/40 pt-3 sm:pt-4 pointer-events-auto">
